...
export const moduleConfigs = {
  ...
  reviews: {
    title: 'Reviews & Q&A',
    subtitle: 'Moderate ratings, buyer images, questions, and seller replies.',
    collectionName: COLLECTIONS.reviews,
    icon: Star,
    primaryAction: 'Add Review',
    accent: '#ca8a04',
    fields: [
      text('productName', 'Product', 'LS2 FF800 Storm'),
      text('customer', 'Customer', 'Rohit Mehta'),
      number('rating', 'Rating', '5'),
      select('verifiedPurchase', 'Verified Purchase', ['yes', 'no']),
      area('review', 'Review', 'Excellent fit and ventilation.'),
      area('reply', 'Seller Reply', 'Thank you for your feedback.')
    ],
    columns: ['productName', 'customer', 'rating', 'verifiedPurchase', 'review', 'reply'],
    seed: [
      { productName: 'LS2 FF800 Storm', customer: 'Rohit Mehta', rating: 5, verifiedPurchase: 'yes', review: 'Excellent fit and ventilation.', reply: 'Thank you for riding with Nitroxx.' }
    ]
  },
  promotions: {
    title: 'Promotions',
